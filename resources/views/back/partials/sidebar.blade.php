<div class="sidebar-nav">
    <div class="well">
		<ul class="nav nav-list">
          ...
          <li><a href="{{ URL::to('admin/products') }}"><i class="icon-envelope"></i> Products <span class="badge badge-info">{{ $total_products }}</span></a></li>
          <li><a href="{{ URL::to('admin/categories') }}"><i class="icon-comment"></i> Categories <span class="badge badge-info">10</span></a></li>
          <li><a href="#"> Orders <span class="badge badge-info">10</span></a></li>
		  <li class="active"><a href="{{ URL::to('admin/customers') }}"><i class="icon-user"></i> Customers </a></li>
          <li class="divider"></li>
