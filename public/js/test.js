...
},{"moment":6}],43:[function(require,module,exports){
/*!
...
var Dashboard = function () {
	...
	_createClass(Dashboard, [{
		...
		value: function updateSalesDate() {
			...
			var dateRange = new _Utils2.default().formatDate();
		...
		value: function drawCanvas() {
			...
			var monthsForReport = new _Utils2.default().getMonths();
			var myChart = new Chart.Line(salesChartCanvas, {
				type: 'line',
				data: {
...
},{"jquery":43}],46:[function(require,module,exports){
'use strict';
...
var Utils = function () {
	...
	_createClass(Utils, [{
		...
		value: function getMonths() {
			...
			return currentMonth === 0 ? ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"] : months;
		}
	}]);
...
console.log(new _MakeRequest2.default().getData());

},{"./components/Dashboard":44,"./components/MakeRequest":45,"chart.js":7}]},{},[47]);
